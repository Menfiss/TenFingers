...
function ExerciseButton (props:props) {
    ...
    const renderStars = () => {
        ...
        const grayStar = "w-4 h-4 text-gray-500";
        const bigGoldStar = "w-6 h-6 text-yellow-300";
        const bigGrayStar = "w-6 h-6 text-gray-500";
        const silverStar = "w-4 h-4 text-gray-300";
