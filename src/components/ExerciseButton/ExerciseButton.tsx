...
function ExerciseButton (props:props) {
    ...
    const renderStars = () => {
        const yellowStar = "w-4 h-4 text-yellow-300";
        const grayStar = "w-4 h-4 text-gray-300 dark:text-gray-500";
        const bigYellowStar = "w-6 h-6 text-yellow-300";
        const bigGrayStar = "w-6 h-6 text-gray-300 dark:text-gray-500";
